...
################################################################################
{
    ...
    'description': "Option to select the customised Receipts for each POS. So, "
                   "we can easily update the Receipt Design for better styles",
    'author': 'Cybrosys Techno Solutions',
    'company': 'Cybrosys Techno Solutions',
    'maintainer': 'Cybrosys Techno Solutions',
    'website': 'https://www.cybrosys.com',
    'depends': ['point_of_sale'],  # 'base' is implicit, not needed
    'data': [
    ...
    'point_of_sale._assets_pos': [
        ...
        'custom_receipts_for_pos/static/src/xml/order_receipt.xml',  # UNCOMMENTED NOW
    ],
},
